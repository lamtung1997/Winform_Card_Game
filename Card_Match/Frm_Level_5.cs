...
{
    public partial class Frm_Level_5 : Form
    {
        ...
        private void Frm_Level_1_Load(object sender, EventArgs e)
        {
            ...
            StreamReader sr = new StreamReader(Directory.GetCurrentDirectory() + "\\Resources\\Records\\records5.bin");
        ...
        private void Card_24_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 24;
            Open_Card();
        }

        private void Card_25_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 25;
            Open_Card();
        }

        private void Card_26_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 26;
            Open_Card();
        }

        private void Card_27_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 27;
            Open_Card();
        }

        private void Card_28_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 28;
            Open_Card();
        }

        private void Card_29_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 29;
            Open_Card();
        }

        private void Card_30_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 30;
            Open_Card();
        }

        private void Card_31_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 31;
            Open_Card();
        }

        private void Card_32_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 32;
            Open_Card();
        }

        private void Card_33_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 33;
            Open_Card();
        }

        private void Card_34_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 34;
            Open_Card();
        }

        private void Card_35_Click(object sender, EventArgs e)
        {
            Click_Card_ID = 35;
            Open_Card();
        }
        ...
        private void Check_Two_Card()
        {
            ...
            if (Correct_Count == Play.Number_Of_Card/2)
            {
                ...
                if (Score > Play.Record)
                {
                    ...
                    StreamWriter sw = new StreamWriter(Directory.GetCurrentDirectory() + "\\Resources\\Records\\records5.bin");
