...
{
    public partial class Frm_Level_3 : Form
    {
        ...
        private void Frm_Level_1_Load(object sender, EventArgs e)
        {
            ...
            StreamReader sr = new StreamReader(Directory.GetCurrentDirectory() + "\\Resources\\Records\\records3.bin");
        ...
        private void Check_Two_Card()
        {
            ...
            if (Correct_Count == Play.Number_Of_Card/2)
            {
                ...
                if (Score > Play.Record)
                {
                    ...
                    StreamWriter sw = new StreamWriter(Directory.GetCurrentDirectory() + "\\Resources\\Records\\records3.bin");
